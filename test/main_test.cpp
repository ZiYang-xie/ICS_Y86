...
{
	c.FlashCode("30f2050000000000000030f4000100000000000040240000000000000000b04f2040");
	c.Run();
	EXPECT_EQ(c.d.Stat, SHLT);
	EXPECT_EQ(c.d.CFLAG[0], 1);
	EXPECT_EQ(c.d.CFLAG[1], 0);
...
{
	c.FlashCode("");
	c.Run();
	EXPECT_EQ(c.d.Stat, SHLT);
	EXPECT_EQ(c.d.CFLAG[0], 1);
	EXPECT_EQ(c.d.CFLAG[1], 0);
...
{
	c.FlashCode("30f7000000000000008030f6ffffffffffffffff606775000000000000000000");
	c.Run();
	EXPECT_EQ(c.d.Stat, SHLT);
	EXPECT_EQ(c.d.CFLAG[0], 0);
	EXPECT_EQ(c.d.CFLAG[1], 0);
...
{
	c.FlashCode("30f7ffffffffffffff7f30f6ffffffffffffffff616771000000000000000000");
	c.Run();
	EXPECT_EQ(c.d.Stat, SHLT);
	EXPECT_EQ(c.d.CFLAG[0], 0);
	EXPECT_EQ(c.d.CFLAG[1], 1);
...
{
	c.FlashCode("30f6010000000000000030f7000000000000000040670000000000000000101010");
	c.Run();
	EXPECT_EQ(c.d.Stat, SHLT);
	EXPECT_EQ(c.d.CFLAG[0], 1);
	EXPECT_EQ(c.d.CFLAG[1], 0);
